class ValidationsController < ApplicationController
  ...
  def index
    ...
    if @validations.empty?
      redirect_to new_project_validation_path(@project)
    end
  end
  ...
  def create
    ...
    respond_to do |format|
      if @validation.save
        format.html { redirect_to project_validations_url(@project), notice: 'Validation was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @validation.update(validation_params)
        format.html { redirect_to project_validations_url(@project), notice: 'Validation was successfully updated.' }
  ...
  def destroy
    @validation.destroy
    respond_to do |format|
      format.html { redirect_to project_validations_url(@project), notice: 'Validation was successfully destroyed.' }
  ...
  private
    ...
    def validation_params
      params.require(:validation).permit(:comment, :username, :ranking, :project_id)
    end
